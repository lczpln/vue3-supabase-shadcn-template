      ...
      <form @submit.prevent="handleSubmit">
        <CardHeader>
          ...
          <CardDescription>
            ...
            <router-link class="text-foreground font-medium hover:underline" to="/create-account"
...
import { LogInIcon, Loader } from 'lucide-vue-next'
...
const isLoading = computed(() => loadingStore.isLoading('authentication/login'))
